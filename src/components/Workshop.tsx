        ...
        <section id="workshop" className="py-20 bg-[#FFF0F5] relative overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12 relative z-10">
                ...
                >
                    ...
                    <div className="absolute right-0 bottom-0 top-auto left-auto bg-[url('/images/מאי%20קייק%20כללי/5d234727-21f7-48b8-b5aa-79a9ab01a735.JPG.webp')] bg-cover bg-top w-full h-full"></div>
                </motion.div>
            </div>
        </section>
    );
