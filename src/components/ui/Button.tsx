        ...
        return (
            <button
                ...
                className={cn(
                    ...
                    {
                        'bg-[var(--primary)] text-white hover:bg-[#FFB6C1]/90': variant === 'primary',
                        'border border-[var(--foreground)] bg-transparent hover:bg-[var(--foreground)] hover:text-white': variant === 'outline',
